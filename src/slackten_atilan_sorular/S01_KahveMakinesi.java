...
String boyut oluşturun...
    ...
    do {
        sayac=0;
        kahveSecim = hangiKahveyiIstersin();
        if (kahveSecim.equalsIgnoreCase("turk kahvesi")) {
            System.out.println("turk kahvesi hazirlaniyor");
        } else if (kahveSecim.equalsIgnoreCase("filtre kahve")) {
            System.out.println("filtre kahve hazirlaniyor");
        } else if (kahveSecim.equalsIgnoreCase("espresso")) {
    ...
    public static void sonuc() {
        System.out.println(kahveSecim + boyut +" olarak hazirdir.Afiyet olsun");
    }
    ...
    public static void sekerIsterMisiniz() {
        Scanner scan=new Scanner(System.in);
    ...
    public static String hangiKahveyiIstersin() {
        Scanner scan=new Scanner(System.in);
        System.out.println("hangi kahveyi istersiniz\n" +
                "1-turk kahvesi\n" +
                "2-filtre kahve\n" +
                "3-espresso");
        String kahveSecim= scan.nextLine();
